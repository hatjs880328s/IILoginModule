...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../IILoginModule/Classes/LoginViewController.xib"
  install_resource "${PODS_ROOT}/IIOCBIZUti/IIOCBIZUti/Classes/Global/ContactProgress.xib"
  ...
  install_resource "${PODS_ROOT}/IIOCUtis/IIOCUtis/Classes/IIProgressHUD/jg_hud_error@3x.png"
  install_resource "${PODS_ROOT}/IIOCUtis/IIOCUtis/Classes/IIProgressHUD/jg_hud_success.png"
  install_resource "${PODS_ROOT}/IIOCUtis/IIOCUtis/Classes/IIProgressHUD/jg_hud_success@2x.png"
  install_resource "${PODS_ROOT}/IIOCUtis/IIOCUtis/Classes/IIProgressHUD/jg_hud_success@3x.png"
fi
